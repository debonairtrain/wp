...
maxLivePreview.prototype.init = function ()
{
  ...
  this.bindFields();
	...
	this.preview_button_normal = $(document.getElementById('debbuttons_preview_normal'));
	this.preview_button_hover = $(document.getElementById('debbuttons_preview_hover'));
...
maxLivePreview.prototype.bindFields = function()
{
  ...
  $('#debbuttons input,#debbuttons textarea').not('.mb-color-field').on('keyup change', $.proxy(this.update_preview_event,this));
  $('#debbuttons select').on('change', $.proxy(this.update_preview_event, this));
