...
class gradientBlock extends maxBlock
{
	...
	public function admin_fields($screen)
	{
			...
			$start_block->name = __('gradient-options', 'debbuttons');
			$start_block->label = __('Background', 'debbuttons');
			$screen->addField($start_block);
				...
				$useg->label = __('Use Gradients', 'debbuttons');
				...
				$fspacer->label = __('Start','debbuttons');
				...
				// Spacer
				$fspacer = clone $fspacer;
				$fspacer->label = __('End','debbuttons');
				...
				$color->name = $color->id;
				$color->value = $g_start;
				$color->label = __('Background color','debbuttons');
			  ...
			  $screen->addField($ecolor, '', 'end');
				...
				$color_hover->label = __('Background hover','debbuttons');
			...
			//	$ecolor_hover->label = __('Color Hover End','debbuttons');
				...
				$screen->addField($ecolor_hover, '', 'end');
					...
					$startop->label = __('Normal Opacity','debbuttons');
					...
					$startop = new maxField('number');
					$startop->label = __('Hover opacity','debbuttons');
					...
					$endop = new maxField('number');
			//		$endop->label = __('Hover Opacity','debbuttons');
					...
					$stop->label = __('Gradient stop','debbuttons');
