...
class textBlock extends maxBlock
{
	...
	{
		parent::__construct();
		$this->fields["text"]["default"] = __("YOUR TEXT","debbuttons");
	}
	...
	/*	foreach($this->fields as $field => $options)
		...
		$color_copy_move  = __("Copy Color to other field", "debbuttons");
				...
				$start_block->name = __('shadow', 'debbuttons');
				$start_block->label = __('Text Shadow', 'debbuttons');
				$screen->addField($start_block);


 					// Shadow offset left
 					$field_shadow = new maxField('number') ;
					$field_shadow->label = __('Shadow Offset Left', 'debbuttons');
					...
					// Shadow offset top
 					$field_shadow = new maxField('number') ;
					$field_shadow->label = __('Shadow Offset Top', 'debbuttons');
					...
					// Shadow width
 					$field_shadow = new maxField('number') ;
					$field_shadow->label = __('Shadow Blur', 'debbuttons');
					...
					$screen->addField($field_shadow, 'start', 'end');
 					...
 					$fshadow->label = __('Shadow Color','debbuttons');
					...
					$screen->addField($fshadow, 'start');
 					...
 					$fshadow_hover->label = __('Hover','debbuttons');
