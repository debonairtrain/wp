...
class debButtons
{
	...
	*/
	...
	public static function ajax_action()
	{
		...
		$debbuttons_capabilities = MB()->get_user_level();
		if (! current_user_can($debbuttons_capabilities))
		{
		...
		switch($action)
		{
			case "delete":
				...
				//$redirect_url = admin_url() . 'admin.php?page=debbuttons-controller&action=list&message=1delete';
			break;
			...
			case "trash":
				...
				//$redirect_url = admin_url() . 'admin.php?page=debbuttons-controller&action=list&message=1';
			break;
			case "restore":
				...
				//$redirect_url = admin_url() . 'admin.php?page=debbuttons-controller&action=list&status=trash&message=1restore';
			break;
			case "copy":
				$button->set($button_id);
				$new_id = $button->copy();
				$redirect = add_query_arg(array('action' => 'edit', 'id' => $new_id, 'copied' => 1), $redirect);
				//$redirect_url = admin_url() . 'admin.php?page=debbuttons-controller&action=button&id=' . $new_id;
			break;
			case 'empty-trash':
		...
		//	$redirect_url = admin_url() . 'admin.php?page=debbuttons-controller&action=list&message=empty-trash';
			break;
			default:
