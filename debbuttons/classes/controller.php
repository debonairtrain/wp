...
abstract class MaxController
{
  ...
  {
     $link = admin_url() . 'admin.php?page=debbuttons-controller&action=edit';
     if ($button_id > 0)
     {
  ...
  {
     $link = admin_url() . 'admin.php?page=debbuttons-controller&view=' . $view;
     $link = add_query_arg($args,$link);
     return esc_url_raw($link);
  ...
  protected function loadFormActions()
  {
    ...
    $actions['add-new'] = array('href' => $this->getButtonLink(), 'text' => __('Add New', 'debbuttons'), 'class' => '');
    $actions['save'] = array('href' => 'javascript:void(0)', 'text' =>  __('Save', 'debbuttons'), 'class' => 'button button-save disabled');
    $actions['copy'] = array('href' => 'javascript:void(0)', 'text' => __('Copy', 'debbuttons'), 'class' => 'maxmodal button', 'id' => 'button-copy',
        'modal' => 'copy-modal');
    $actions['trash'] = array('href' => 'javascript:void(0)', 'text' => __('Move to Trash', 'debbuttons'), 'class' => 'maxmodal button', 'id' => 'button-trash', 'modal' => 'trash-modal');
    $actions['delete'] = array('href' => 'javascript:void(0)', 'text' => __("Delete","debbuttons"), 'class' => 'maxmodal button', 'id' => 'button-delete', 'modal' => 'delete-modal');

    return apply_filters('debbuttons/editor/actions',$actions);
  }
