 ...
 */
class DebButton_Widget_Field_DebButton extends \SiteOrigin_Widget_Field_Base {
	/**
...
//	protected $library;
	...
	protected function get_default_options() {
		return array(
			'choose' => __( 'Choose Debbutton', 'debbuttons' ),
			'update' => __( 'Set Media', 'debbuttons' ),
		//	'library' => 'image'
		);
	}
	...
	protected function render_field( $value, $instance ) {
		...
		<script language="javascript">
			...
			{
				var button = jQuery('.media-popup .debbutton-' + id).parents('.shortcode-container').children().clone();
				var button_id = id;
		 ...
		 <button class="button-primary debbutton_media_button"
		...
		<p><h3><?php _e('Selected Button', 'debbuttons') ?></h3></p>
