...
class gutenBerg{
  ...
  public static function init()
  {
      ...
      add_action( 'debbuttons/ajax/gutenberg_button', array(maxUtils::namespaceit('gutenBerg'), 'generate_button'));
  ...
  public static function editor_scripts()
  {
    ...
    wp_register_script(
  		'debbuttons_gutenberg-js', // Handle.
    ...
    wp_localize_script('debbuttons_gutenberg-js', 'mb_gutenberg', array(
        'ispro' => (defined('debbuttons_PRO_ROOT_FILE')) ? 1 : 0,
        'icon_url' => MB()->get_plugin_url() . '/images/mb-32.png',
    ));


    wp_enqueue_script('debbuttons_gutenberg-js');

  	// Styles.
  	wp_enqueue_style(
  		'debbuttons_block-editor-css', // Handle.
  ...
  public static function register_block()
  {
    ...
    {
      register_block_type( 'debbuttons/debbuttons-block', array(
  ...
  public static function generate_button($post)
  {
    ...
    $response = array(
        'button' => $the_button,
        'style' => admin_url('admin-ajax.php'). '?action=debbuttons_front_css&id=' . $id,
        'attributes' => false,
      );
