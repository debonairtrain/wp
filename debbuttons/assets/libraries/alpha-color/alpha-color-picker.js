 ...
 */
 ...
 /* DebButtons NOTE WHEN UPDATING:  _addInputListeners function changed to accomodate for empty input ( == transparant )  -
 */
		...
		_addInputListeners: function( input ) {
			var self = this,
				...
				callback = function( event ){
					var val = input.val();
					// DebButtons: make empty input field transparent color
					if (val == '' )
					{
