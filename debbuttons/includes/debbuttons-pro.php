...
$page_title = __("Upgrade to Pro","debbuttons");
...
' . $checkout_url . '&utm_source=mbf-dash' . $version . '&utm_medium=mbf-plugin&utm_content=buy-now&utm_campaign=buy-now-top' . $version . '" target="_blank">' . __("Buy Now", "debbuttons") . "</a>";
...
?>
   ...
   <link href='https://fonts.googleapis.com/css?family=Quicksand:400,700' rel='stylesheet' type='text/css'>
	...
	<div class="license-section">
		...
		<form id="license_form" class='license_form' method="POST" action="<?php echo $this->url ?>">
			...
			<h3><?php _e('Already have a License?', 'debbuttons'); ?></h3>
			<p><?php _e('Enter your license key and install DebButtons PRO. If the license key is valid, the plugin will activate the license, download the plugin and install it. This can take a while!', 'debbuttons'); ?></p>

			<p><input type="text" name="license_key" value="<?php echo $this->view->licenseKey ?>" placeholder="<?php _e('DebButtons PRO License Key', 'debbuttons') ?>"></p>

			<p>
			<button type="submit" class='button button-primary'><?php _e('Upgrade to DebButtons PRO','debbuttons-pro'); ?></button>
		</p>
		</form>
  ...
  <div class="default-section">
    <div class="container">
      <h2>Build Even Better WordPress Buttons with DebButtons Pro!</h2>
      <p>
  ...
  <div class="default-section">
    <div class="container">
      <h2>More Effective Buttons Are Made with DebButton Pro's Advanced Features</h2>
  ...
  <div class="default-section">
    <div class="container">
      ...
      <p>
        Download any of our free button packs included with DebButtons Pro and load them onto your site in seconds!
      </p>
      <div class="image-row">
        <div class="width-33">
  ...
  <div class="default-section">
    <div class="container">
      ...
      <p>
        DebButtons Pro includes 17 Designed and Configured Social Share Collections to get the Most Value From your Content Marketing.
      </p>
      <p>
        Use one of our Collections out of the Box or Customize Your Icons with DebButtons Pro's Editor.
      </p>
      <p>
