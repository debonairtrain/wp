					...
					<div id="postbox-container-2" class="postbox-container">
						<div id="advanced" class="meta-box-sortables">
							<div id="gallery_bank_get_started" class="postbox" >
								...
								<h2 class="hndle" style="text-align:center;font-size:30px;"><span><?php esc_html_e('More Free Plugins Recommendation From Wpshopmart',wpshopmart_test_d_text_domain); ?></span></h3>
								<div class="inside">
																...
																<div class="plugin-div-top plugin-div-settings-top">
																	<div class="plugin-div-inner-content">
																		...
																		<div class="desc column-description">
																			...
																			<p class="authors">
																				<cite>
																					<?php esc_html_e('By ',wpshopmart_test_d_text_domain);?> <?php  echo wp_kses_data($author);?>
																				</cite>
																			</p>
																		</div>
																	</div>
