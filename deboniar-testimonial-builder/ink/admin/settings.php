...
if ( ! defined( 'ABSPATH' ) ) exit;
  ...
  $De_Settings = unserialize(get_option('test_D_default_Settings'));
  $PostId = $post->ID;
...
if(isset($_POST['action123']) == "default_settins_action")
	{
		...
		"carousel_dot_hover_bgclr" => $carousel_dot_hover_bgclr
			...
			update_option('test_D_default_Settings', $Settings_Array2);
}

 ?>
<input type="hidden" name="wpsm_security" value="<?php echo esc_attr( $wpsm_nonce ); ?>">
<input type="hidden" id="test_d_setting_save_action" name="test_d_setting_save_action" value="test_d_setting_save_action"/>

<table class="form-table acc_table">
	<tbody>
		<tr>
			<th scope="row"><label><?php esc_html_e('Testimonial Name Color',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="test_mb_name_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Update Your Testimonial Name Color Here',wpshopmart_test_d_text_domain); ?></h2>
						<img src="<?php echo esc_url(wpshopmart_test_d_directory_url.'assets/tooltip/img/name-clr.png'); ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php esc_html_e('Testimonial Designation Color',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="test_mb_pos_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Update Your Testimonial Designation Color Here',wpshopmart_test_d_text_domain); ?></h2>
						<img src="<?php echo esc_url(wpshopmart_test_d_directory_url.'assets/tooltip/img/desig-color.png'); ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php esc_html_e('Website Link Color',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="test_mb_desc_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Update Your Testimonial Website Link Color Here',wpshopmart_test_d_text_domain); ?></h2>
						<img src="<?php echo esc_url(wpshopmart_test_d_directory_url.'assets/tooltip/img/link-clr.png'); ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php esc_html_e('Testimonial Description Color',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="test_mb_social_icon_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Update Your Testimonial Description Color Here',wpshopmart_test_d_text_domain); ?></h2>
						<img src="<?php echo esc_url(wpshopmart_test_d_directory_url.'assets/tooltip/img/desc-color.png'); ?>">
					</div>
		    	</div>
			</td>
		</tr>
		<tr class="setting_color">
			<th><label><?php esc_html_e('Name Font Size',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="title_size_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('You can update Name Font Size from here. Just Scroll it to change size.',wpshopmart_test_d_text_domain)?></h2>
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr class="setting_color">
			<th><label><?php esc_html_e('Designation Font Size',wpshopmart_test_d_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#test_mb_social_icon_bg_clr_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
				...
				<div id="title_size_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('You can update Designation Font Size from here. Just Scroll it to change size.',wpshopmart_test_d_text_domain); ?></h2>
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr class="setting_color">
			<th><label><?php esc_html_e('Website Link Font Size',wpshopmart_test_d_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#test_mb_social_icon_bg_clr_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
				...
				<div id="title_size_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('You can update Website Link Font Size from here. Just Scroll it to change size.',wpshopmart_test_d_text_domain); ?></h2>
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr class="setting_color">
			<th><label><?php esc_html_e('Testimonial Description Font Size',wpshopmart_test_d_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#test_mb_social_icon_bg_clr_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
				...
				<div id="title_size_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('You can update Testimonial Description Size from here. Just Scroll it to change size.',wpshopmart_test_d_text_domain); ?></h2>
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr >
			<th><label><?php esc_html_e('Font Style/Family',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="font_family_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('You can update Testimonial name , designation and Description Font Family/Style from here. Select any one form these options.',wpshopmart_test_d_text_domain); ?></h2>

					</div>
		    	</div>
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px" href="https://wpshopmart.com/plugins/testimonial-pro/" target="_blank"><?php esc_html_e('Get 500+ Google Fonts In Premium Version',wpshopmart_test_d_text_domain); ?></a> </div>
		...
		<tr>
			<th><label><?php esc_html_e('Testimonial Column Display layout ',wpshopmart_test_d_text_domain); ?> </label>
			...
			<td>
				<select name="test_layout" id="test_layout" class="standard-dropdown" style="width:100%" >
						<option value="12"  <?php if($test_layout == '12') { echo "selected"; } ?>><?php esc_html_e('One Column Layout',wpshopmart_test_d_text_domain); ?></option>
						<option value="6"  <?php if($test_layout == '6') { echo "selected"; } ?>><?php esc_html_e('Two Column Layout',wpshopmart_test_d_text_domain); ?></option>
						<option value="4"  <?php if($test_layout == '4') { echo "selected"; } ?>><?php esc_html_e('Three Column Layout',wpshopmart_test_d_text_domain); ?></option>


				</select>
				<div id="test_layout_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Testimonial Column Display layout',wpshopmart_test_d_text_domain); ?></h2>
					</div>
		    	</div>
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px" href="https://wpshopmart.com/plugins/testimonial-pro/" target="_blank"><?php esc_html_e('Unlock 6+ More Display layouts In Premium Version',wpshopmart_test_d_text_domain); ?></a> </div>

			</td>
		</tr>
		<tr>
			<th scope="row"><label><?php esc_html_e('Testimonial Background Color For Design-2',wpshopmart_test_d_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#test_mb_desc_clr_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
				...
				<div id="test_mb_desc_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Update Your testimonial Design Background Color Here',wpshopmart_test_d_text_domain); ?></h2>
						<img src="<?php echo esc_url(wpshopmart_test_d_directory_url.'assets/tooltip/img/background.png'); ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr class="setting_color">
			<th><label><?php esc_html_e('Website Link Label',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="test_mb_web_link_label_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Update Website Link Label Here',wpshopmart_test_d_text_domain); ?></h2>
					</div>
		    	</div>
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px" href="https://wpshopmart.com/plugins/testimonial-pro/" target="_blank"><?php esc_html_e('Unlock more option like Ratings, emailid and webiste with link in Premium Version',wpshopmart_test_d_text_domain); ?></a> </div>

			</td>
		</tr>

		<tr>
			<th><label><?php esc_html_e('Testimonial Image Design ',wpshopmart_test_d_text_domain); ?> </label>
			...
			<td>
				<select name="test_image_layout" id="test_image_layout" class="standard-dropdown" style="width:100%" >
						<option value="1"  <?php if($test_image_layout == '1') { echo "selected"; } ?>><?php esc_html_e('Rectangle',wpshopmart_test_d_text_domain); ?></option>
						<option value="2"  <?php if($test_image_layout == '2') { echo "selected"; } ?>><?php esc_html_e('Circle',wpshopmart_test_d_text_domain); ?></option>


				</select>
				<div id="test_image_layout_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;"><?php esc_html_e('Select Testimonial Image Design Style Here',wpshopmart_test_d_text_domain); ?></h2>
					</div>
		    	</div>
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px" href="https://wpshopmart.com/plugins/testimonial-pro/" target="_blank"><?php esc_html_e('Unlock 150+ testimonial design templates with different image style in Premium Version',wpshopmart_test_d_text_domain); ?></a> </div>

			</td>
		</tr>
		<tr>
			<th scope="row"><label><?php _e('Display Carousel Dots',wpshopmart_test_d_text_domain); ?></label>
				<!-- Tooltip -->
			...
			<td>
				<div class="switch">
					...
					<label for="enable_test_mb_dots" class="switch-label switch-label-off"><?php _e('Yes',wpshopmart_test_d_text_domain); ?></label>
					...
					<label for="disable_test_mb_dots" class="switch-label switch-label-on"><?php _e('No',wpshopmart_test_d_text_domain); ?></label>
					<span class="switch-selection"></span>
				</div>

				<div id="test_mb_dots_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Display your Carousel Dots here ',wpshopmart_test_d_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_test_d_directory_url.'assets/tooltip/img/displaydots.jpg'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		<tr>
			<th scope="row"><label><?php _e('Carousel Dots Background Color',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="test_mb_dots_bg_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Update Your testimonial Carousel <br/>Dots Background Color Here',wpshopmart_test_d_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_test_d_directory_url.'assets/tooltip/img/dotsbgcolor.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		<tr>
			<th scope="row"><label><?php _e('Carousel Dots Hover/Active Background Color',wpshopmart_test_d_text_domain); ?></label>
			...
			<td>
				...
				<div id="test_mb_dots_hover_bg_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Update Your testimonial Carousel Dots <br/>Hover/Active  Background Color Here',wpshopmart_test_d_text_domain); ?></h2>
						<img src="<?php echo wpshopmart_test_d_directory_url.'assets/tooltip/img/dotshvcolor.jpg'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
