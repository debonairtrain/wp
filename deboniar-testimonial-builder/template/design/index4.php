...
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .wpsm_testimonial .wpsm_testimonial-title{
...
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .wpsm_testimonial > .wpsm_testimonial-review span{
	font-size:<?php echo esc_attr($test_mb_deg_font_size); ?>px !important;
	color:<?php echo esc_attr($test_mb_deg_clr); ?> !important;
	font-family:'<?php  echo esc_attr($test_font_family); ?>';
}
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .wpsm_testimonial .wpsm_testi_links{
...
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .wpsm_testimonial .wpsm_testi_description{
...
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .wpsm_testimonial .wpsm_testi_content{
	background:<?php echo esc_attr($bgclr_style2); ?> !important;
}
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .wpsm_testimonial .wpsm_testi_content:after{
	  border-top: 10px solid <?php echo esc_attr($bgclr_style2); ?> !important;
}
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .wpsm_testimonial-pic > img{
...
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .owl-dots{
...
#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .owl-dots span
{
	background:<?php echo esc_attr($carousel_dot_bgclr);?>;
}

#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .owl-dot.active span{
		background:<?php echo esc_attr($carousel_dot_hover_bgclr);?>;
}

#wpsm_testi_d_row_<?php echo esc_attr($post_id); ?> .owl-dot:hover span{
		background:<?php echo esc_attr($carousel_dot_hover_bgclr);?>;
}
